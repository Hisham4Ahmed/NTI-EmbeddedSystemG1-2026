...
#define GICR_Reg            *((volatile uint8_t*)0x5D)
#define GIFR_Reg            *((volatile uint8_t*)0x5C)
#define TIMSK_Reg           *((volatile uint8_t*)0x5B)
#define TIFR_Reg            *((volatile uint8_t*)0x5A)
#define SPMCR_Reg           *((volatile uint8_t*)0x59)
#define TWCR_Reg            *((volatile uint8_t*)0x58)
#define MCUCR_Reg           *((volatile uint8_t*)0x57)
#define MCUCSR_Reg          *((volatile uint8_t*)0x56)
#define TCCR0_Reg           *((volatile uint8_t*)0x55)
#define TCNT0_Reg           *((volatile uint8_t*)0x54)
#define OSCCAL_Reg          *((volatile uint8_t*)0x53)
#define OCDR_Reg            *((volatile uint8_t*)0x52)
#define SFIOR_Reg           *((volatile uint8_t*)0x51)
#define TCCR1A_Reg          *((volatile uint8_t*)0x50)
#define TCCR1B_Reg          *((volatile uint8_t*)0x4F)
#define TCNT1H_Reg          *((volatile uint8_t*)0x4E)
#define TCNT1L_Reg          *((volatile uint8_t*)0x4D)
#define OCR1AH_Reg          *((volatile uint8_t*)0x4C)
#define OCR1AL_Reg          *((volatile uint8_t*)0x4B)
#define OCR1BH_Reg          *((volatile uint8_t*)0x4A)
#define OCR1BL_Reg          *((volatile uint8_t*)0x49)
#define ICR1H_Reg           *((volatile uint8_t*)0x48)
#define ICR1L_Reg           *((volatile uint8_t*)0x47)
#define TCCR2_Reg           *((volatile uint8_t*)0x46)
#define TCCR2_Reg           *((volatile uint8_t*)0x45)
#define OCR2_Reg            *((volatile uint8_t*)0x44)
#define ASSR_Reg            *((volatile uint8_t*)0x43)
#define WDTCR_Reg           *((volatile uint8_t*)0x42)
#define UBRRH_Reg           *((volatile uint16_t*)0x41)
